...
if __name__ == "__main__":
    ...
    # Test 2: Synthetic rectangle (no real face)
    single = np.zeros((480, 640, 3), dtype=np.uint8)
    cv2.rectangle(single, (200, 100), (440, 380), (120, 100, 80), -1)
    run_flow("Synthetic single object", single)

    # Test 3: Two rectangles (multiple detection scenario)
    ...
    run_flow("Two synthetic objects", multi)
